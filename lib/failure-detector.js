...
function FailureDetector(opts) {
  ...
  this.pingReqTimeout =
    opts.pingReqTimeout || FailureDetector.Default.pingReqTimeout;
  this.pingReqGroupSize =
    opts.pingReqGroupSize || FailureDetector.Default.pingReqGroupSize;
  ...
  this.debug = debug("swim:failure-detector").bind(
    undefined,
    opts.debugIdentifier
  );
}
...
FailureDetector.prototype.stop = function stop() {
  ...
  Object.keys(self.seqToTimeout).forEach(function clearTimeoutWithDeletion(
    seq
  ) {
...
FailureDetector.prototype.pingReq = function pingReq(member) {
  ...
  relayMembers.forEach(function pingThrough(relayMember) {
    self.pingReqThroughMember(
      member,
      relayMember,
      function pingReqThroughMemberCallback() {
...
FailureDetector.prototype.pingReqThroughMember = function pingReqThroughMember(
  member,
  relayMember,
  callback
) {
